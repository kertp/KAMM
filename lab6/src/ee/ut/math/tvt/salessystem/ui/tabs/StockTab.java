...
public class StockTab implements RefreshableTab{
	...
	public void refresh(SalesDomainController domainController) {
		...
		List<StockItem> data = domainController.getAllStockItems();
		this.model.getWarehouseTableModel().populateWithData(data);
	}
